...
def get_image_evaluation_prompt(
    ...
    Args:
        input_prompt: The original prompt used for image generation.
        reference_image_descriptions: Descriptions for reference images.
...
def get_video_evaluation_prompt(
    ...
    Args:
        input_prompt: The original prompt used for video generation.
        reference_image_descriptions: Descriptions for reference images.
