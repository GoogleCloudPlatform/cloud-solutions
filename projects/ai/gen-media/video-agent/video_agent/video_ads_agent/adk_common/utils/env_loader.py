...
"""Module providing configuration constants and utilities."""
...
def load_env_cascade(
    current_file: str, dependency_paths: list[str] | None = None
) -> None:
    """
    ...
    Args:
        ...
        dependency_paths: Relative paths to other agents (e.g., ['../ad_gener'
            'ation_agent'])
    """
    ...
    if (agent_root / "pyproject.toml").exists():
        ...
        # Fallback to simple parent traversal if pyproject.toml not found
        # (unlikely)
