...
**Score > 20**: Best match — build the campaign around this trend
**Score 15-20**: Strong match — use as a supporting angle
**Score 10-15**: Opportunity — test in one segment or ad variation
