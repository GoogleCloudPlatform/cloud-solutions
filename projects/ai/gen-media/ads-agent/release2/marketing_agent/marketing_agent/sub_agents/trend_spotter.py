...
from marketing_agent.config import LOCATION, PROJECT_ID
from marketing_agent.schema import TaxonomyAttributes, Trend, TrendSpotterOutput
...
class TrendSpotter:
    ...
    @log_function_call
    def search_trends(
        self, product_category: str, tool_context: ToolContext
    ) -> str:
