...
# pylint: disable=C0114, C0301, C0303, C0412, C0415, W0311, W0404, W0611, W0612, W0718, W1309, W1405
...
def create_bucket_from_spec(
    ...
    try:
        ...
        bucket_resource.iam_configuration.uniform_bucket_level_access_enabled = (
            True
        )
        ...
        print(
            f"Attempting to create bucket '{bucket_name}' in {bucket_location}..."
        )
...
def get_files_metadata_from_gcs_bucket(
    ...
    log_message(
        f"Listing files in gs://{bucket_name}/{prefix or ''}...", Severity.INFO
    )
    try:
        blobs = storage_client.list_blobs(bucket_name, prefix=prefix)
