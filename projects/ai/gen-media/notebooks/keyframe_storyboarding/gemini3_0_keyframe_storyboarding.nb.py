...
# %%
# # %pip install --upgrade --quiet google-genai google-adk ipywidgets ipython matplotlib pandas
...
# %%
PROJECT_ID = "consumer-genai-experiments"  # @param {type: "string", placeholder: "[your-project-id]", isTemplate: true}
...
async def generate_image_async(
    ...
    Args:
        ...
        model_id: Model identifier string (e.g., "gemini-3-pro-image-preview")
