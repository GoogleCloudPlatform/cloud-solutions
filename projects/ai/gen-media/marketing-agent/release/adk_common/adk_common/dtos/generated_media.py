...
class GeneratedMedia(BaseModel):
    ...
    def to_obj_sans_bytes(self) -> dict[str, str | None]:
        """
        Serializes the object to a dict without the media_bytes.
        """
    ...
    def to_obj_with_base64_bytes(self) -> dict[str, str | None]:
        """
        Serializes the object to a dict with media_bytes as base64.
        """
        ...
        return {
            ...
            "gcs_uri": self.gcs_uri,
            "media_bytes": (
                base64.b64encode(self.media_bytes).decode("utf-8")
                if self.media_bytes
                else None
            ),
        }
