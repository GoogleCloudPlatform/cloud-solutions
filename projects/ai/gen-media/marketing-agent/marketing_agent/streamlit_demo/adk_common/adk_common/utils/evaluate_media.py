...
from adk_common.utils.evaluation_prompts import (
...
async def evaluate_media(
    ...
    mime_type: str,
    evaluation_criteria: str,
    reference_images: list[tuple[genai.types.Part, str]] | None = None,
    allow_collage: bool = False,
) -> EvalResult:
    ...
    try:
        ...
        async with get_evaluation_semaphore():
            ...
            from adk_common.utils.gemini_utils import get_gemini_client
