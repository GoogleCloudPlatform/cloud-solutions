...
Position the product as the best-in-class. Use superlatives backed by proof
points.

- "The most advanced [category] ever made"
- Best for: premium products, market leaders, products with clear
  differentiators
...
Lead with a pain point the audience recognizes, then present the product as the
answer.
...
1.  **Demographics**: Age range, income level, location type
    (urban/suburban/rural)
1.  **Psychographics**: Values, interests, lifestyle, aspirations
1.  **Behavioral**: Purchase frequency, brand loyalty, media consumption
1.  **Pain Points**: What problems does this segment face that the product
    solves?
1.  **Media Channels**: Where does this segment spend attention?
...
- **Product Fit**: How does this product address job + relieve pain + create
  gain?
...
1.  **Objective**: What is the campaign trying to achieve? (awareness,
    consideration, conversion)
1.  **Target**: Who are we talking to? (segment description)
1.  **Insight**: What human truth or tension does this campaign tap into?
1.  **Proposition**: What single message do we want them to take away?
1.  **Tone**: How should the campaign feel? (confident, playful, authoritative,
    warm)
1.  **Mandatories**: What must be included? (logo, product shot, legal
    disclaimers)
