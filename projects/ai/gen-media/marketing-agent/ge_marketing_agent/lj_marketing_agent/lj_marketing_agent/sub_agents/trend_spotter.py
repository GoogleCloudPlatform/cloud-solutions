...
from ...adk_common.utils.utils_prompts import (
    load_prompt_file_from_calling_agent,
)
from ..config import PROJECT_ID


class TrendSpotter:
    """Sub-agent responsible for discovering market trends using Google Search grounding."""
    ...
    @log_function_call
    def search_trends(
        self, product_category: str, _tool_context: ToolContext
    ) -> str:
        ...
        try:
            ...
            return (
                result_text.strip() if result_text else "No trend data found."
            )
