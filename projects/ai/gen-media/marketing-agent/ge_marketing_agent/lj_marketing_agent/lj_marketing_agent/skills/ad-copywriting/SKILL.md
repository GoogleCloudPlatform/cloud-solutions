...
1.  **Headline 1 — Primary Hook**: Lead with the strongest benefit or the brand
    name. This headline shows most often.
1.  **Headline 2 — Value Proposition**: Differentiate from competitors. What
    makes this product unique?
1.  **Headline 3 — Call-to-Action or Social Proof**: Drive urgency or trust
    ("Shop Now", "Award-Winning", "Free Shipping").
...
1.  **Description 1 — Expand the Hook**: Elaborate on the primary benefit with
    specifics.
1.  **Description 2 — Features + Benefits**: 2-3 key features tied to outcomes.
1.  **Description 3 — CTA + Trust Signal**: Clear action + reason to act now.

### Description Frameworks

- **PAS (Problem-Agitate-Solve)**: State problem → amplify pain → present
  solution
- **BAB (Before-After-Bridge)**: Current state → desired state → product as
  bridge
- **4U (Urgent, Unique, Ultra-specific, Useful)**: Every description should hit
  at least 2
