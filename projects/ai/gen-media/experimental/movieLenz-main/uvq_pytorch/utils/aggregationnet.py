...
MODEL_DIR = os.path.join(
    os.path.dirname(__file__), "..", "checkpoint/aggregationnet_models"
)
...
class AggregationNet(nn.Module):
    """Aggregation network for combining multiple subnet features."""
    ...
    def __init__(
        ...
        self.linear1 = nn.Linear(
            bias=True, in_features=num_filters, out_features=1
        )
...
class AggregationNetInference:
    """Inference helper for AggregationNet models."""
