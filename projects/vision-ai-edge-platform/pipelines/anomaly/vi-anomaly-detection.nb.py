...
# ! gcloud storage buckets add-iam-policy-binding $BUCKET_URI --member="serviceAccount:{SERVICE_ACCOUNT_EMAIL}" --role="roles/storage.objectCreator"

# ! gcloud storage buckets add-iam-policy-binding $BUCKET_URI --member="serviceAccount:{SERVICE_ACCOUNT_EMAIL}" --role="roles/storage.objectViewer"
