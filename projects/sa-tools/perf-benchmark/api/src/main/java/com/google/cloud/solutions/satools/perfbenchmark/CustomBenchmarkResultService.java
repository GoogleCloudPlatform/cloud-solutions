...
/** A service to retrieve results of a custom PKB Benchmark run. */
public interface CustomBenchmarkResultService {
  BenchmarkJobResult retrieveResult(BenchmarkJobEntity benchmarkJobEntity);
}
