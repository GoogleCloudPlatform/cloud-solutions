...
/**
 * An audio worklet processor that stores the PCM audio data sent from the
 * main thread to a buffer and plays it.
 */
class PCMPlayerProcessor extends AudioWorkletProcessor {
  ...
  // The system calls `process()` ~128 samples at a time (depending on the
  // browser).
