...
variable "mcp_webhook_token_secret_name" {
  type        = string
  default     = "oracle-mcp-webhook-token"
  description = "The Secret Manager secret identifier containing the shared MCP webhook token"
}

variable "mcp_webhook_token_value" {
  type        = string
  default     = null
  description = "Optional pre-shared secret token value. If omitted (recommended), a token is auto-generated by Terraform"
  sensitive   = true
}
